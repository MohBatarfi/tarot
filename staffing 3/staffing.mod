...
subject to {
	...
	forall(WeekdayAssigned in Weekdays, PeriodAssigned in Periods, RoomAssigned in Rooms, ProfessorAssigned in Professors, CourseAssigned in Courses)
     	// To assign a professor to teach a course in a specific time and room
		Assign[WeekdayAssigned][PeriodAssigned][RoomAssigned][ProfessorAssigned][CourseAssigned] == 1;
